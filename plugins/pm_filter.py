...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton(f"{stat}", callback_data=f"{cb}:{group_id}"),
             InlineKeyboardButton("🗑️ᴅᴇʟᴇᴛᴇ🗑️", callback_data=f"deletecb:{group_id}")],
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('📣ᴜᴩᴅᴀᴛᴇꜱ📣', url='https://t.me/KOMBOTZZ'),
            InlineKeyboardButton('👨‍💻ꜱᴩᴜʀᴄᴇ👨‍💻', callback_data='source')
        ], [
            InlineKeyboardButton('🏡ʜᴏᴍᴇ🏡', callback_data='start'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🎛️ʙᴜᴛᴛᴏɴꜱ🎛️', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('❰ ʙᴀᴄᴋ', callback_data='help'),
            InlineKeyboardButton('♻️ʀᴇꜰʀᴇꜱʜ♻️', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
